        ...
        try {
            while ((file = in.readLine()) != null) {
                ...
                outer: while(true) {
                    ...
                    GameStateTimeline<GLDrawState> timeline =
                        new GameStateTimeline<GLDrawState>(match, GLDrawState.FACTORY, 10);
                    GLDrawState ds = new GLDrawState();

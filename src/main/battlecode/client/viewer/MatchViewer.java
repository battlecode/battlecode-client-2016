      ...
      Observer paintObserver = new Observer() {
          public void update(Observable o, Object arg) {
            ...
            info.updateDebugChanges(robot, clampedXLoc, clampedYLoc,
                                    br.getDrawState().getGameMap().
				    getInitialOre(new MapLocation(clampedXLoc, clampedYLoc))
				    - br.getDrawState().getOreAtLocation
				    (new MapLocation(clampedXLoc, clampedYLoc)),
